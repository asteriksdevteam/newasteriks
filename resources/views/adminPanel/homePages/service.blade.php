            ...
            <div class="card">
                <div class="card-body p-0">
                    <div class="card-px py-10 my-10">
                        <form class="form" action="{{ url('updateService') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <h2 class="fw-bolder pb-10">Update Services</h2>
                                ...
                                <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="file" value="" class="form-control form-control-solid second_section_image_1 @error('second_section_image_1') is-invalid @enderror" id="second_section_image_1" name="second_section_image_1" placeholder="Heading"/>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="file" value="" class="form-control form-control-solid second_section_image_2 @error('second_section_image_2') is-invalid @enderror" id="second_section_image_2" name="second_section_image_2"/>
