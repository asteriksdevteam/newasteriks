                    ...
                    <div class="card-px py-10 my-10">
                        ...
                        <div class="py-5 px-lg-17">
                            <div class="me-n7 pe-7">
                                ...
                                <form class="form" action="{{ url('store_jobs') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="fv-row mb-7">
                                                ...
                                                <input type="text" value="" class="form-control form-control-solid job_heading @error('job_heading') is-invalid @enderror" id="job_heading" name="job_heading" placeholder="Enter Job Heading"/>
                                                @error('job_heading')
                                                    <div class="alert alert-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="fv-row mb-7">
                                                ...
                                                <textarea id="job_specification" name="job_specification" class="tox-target @error('job_specification') is-invalid @enderror"></textarea>
                                        ...
                                        <div class="col-md-6">
                                            <div class="fv-row mb-7">
                                                ...
                                                <textarea id="job_overview" name="job_overview" class="tox-target @error('job_overview') is-invalid @enderror"></textarea>
                                                @error('job_overview')
                                                    <div class="alert alert-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="fv-row mb-7">
                                                ...
                                                <textarea id="job_description" name="job_description" class="tox-target @error('job_description') is-invalid @enderror"></textarea>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="fv-row mb-7">
                                                        <input type="checkbox" id="full_allowance" name="full_allowance"/> &nbsp;
                                                        <label class="fs-6 fw-bold mb-2">Fuel Allowance</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="fv-row mb-7">
                                                        <input type="checkbox" id="leave_encashment" name="leave_encashment"/> &nbsp;
                                                        <label class="fs-6 fw-bold mb-2">Leave Encashment</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="fv-row mb-7">
                                                        <input type="checkbox" id="LDopp" name="LDopp"/> &nbsp;
                                                        <label class="fs-6 fw-bold mb-2">Learning & Development Opportunities</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="fv-row mb-7">
                                                        <input type="checkbox" id="recognition_rewards" name="recognition_rewards"/> &nbsp;
                                                        <label class="fs-6 fw-bold mb-2">Recognition & Rewards</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="fv-row mb-7">
                                                        <input type="checkbox" id="medical_insurance" name="medical_insurance"/> &nbsp;
                                                        <label class="fs-6 fw-bold mb-2">Medical Insurance</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="fv-row mb-7">
                                                        <input type="checkbox" id="maternity_paternity_leave" name="maternity_paternity_leave"/> &nbsp;
                                                        <label class="fs-6 fw-bold mb-2">Maternity & Paternity Leave</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="fv-row mb-7">
                                                        <input type="checkbox" id="increment_twice_a_year" name="increment_twice_a_year"/> &nbsp;
                                                        <label class="fs-6 fw-bold mb-2">Increment Twice a Year</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="fv-row mb-7">
                                                        <input type="checkbox" id="paid_time_off" name="paid_time_off"/> &nbsp;
                                                        <label class="fs-6 fw-bold mb-2">Paid Time Off</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="fv-row mb-7">
                                                        <input type="checkbox" id="mental_health_leave" name="mental_health_leave"/> &nbsp;
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="fv-row mb-7">
                                                ...
                                                <input type="number" value="" class="form-control form-control-solid number_of_vacancies @error('number_of_vacancies') is-invalid @enderror" id="number_of_vacancies" name="number_of_vacancies" placeholder="Enter Number of Vacancies"/>
                                        ...
                                        <div class="col-md-6">
                                            <div class="fv-row mb-7">
                                                ...
                                                <input type="number" value="09" class="form-control form-control-solid working_hours @error('working_hours') is-invalid @enderror" id="working_hours" name="working_hours" placeholder="Enter Number of Vacancies"/>
                                                @error('working_hours')
                                                    <div class="alert alert-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
